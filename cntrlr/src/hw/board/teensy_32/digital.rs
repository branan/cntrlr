...
pub fn pin_op<Op: PinOp>(pin: usize, arg: Op::Arg) -> Option<Op::Result> {
    match pin {
        ...
        24 => Op::do_op(port_a().pin::<5>(), arg),
        25 => Op::do_op(port_b().pin::<19>(), arg),
        26 => Op::do_op(port_e().pin::<1>(), arg),
        27 => Op::do_op(port_c().pin::<9>(), arg),
        28 => Op::do_op(port_c().pin::<8>(), arg),
        29 => Op::do_op(port_c().pin::<10>(), arg),
        30 => Op::do_op(port_c().pin::<11>(), arg),
        31 => Op::do_op(port_e().pin::<0>(), arg),
        32 => Op::do_op(port_b().pin::<18>(), arg),
        33 => Op::do_op(port_a().pin::<4>(), arg),
        34 => Op::do_op(port_a().pin::<1>(), arg),
        _ => None,
    }
}
...
///
/// The digital pins on the Teensy 3.2 are 5V tolerant, but use
/// 3.3V thresholds.
///
...
///
/// The digital pins on the Teensy 3.2 output 3.3V.
///
