use crate::{
    hw::{
        ...
        mcu::kinetis::{
            mk20dx128::{Pin, Sim, Uart, UartRx, UartTx},
            Mk20Dx128,
        },
    },
    io,
...
impl io::Serial for Serial<Mk20Dx128, Serial2Tx, Serial2Rx, 1> {
    type Error = SerialError;
...
impl io::Serial for Serial<Mk20Dx128, Serial3Tx, Serial3Rx, 2> {
    type Error = SerialError;
