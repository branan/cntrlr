...
impl super::spi::Sdi<Mk66Fx1M0, 1> for Sdi<Pin<'_, Mk66Fx1M0, 1, 17>> {}
impl super::spi::Sdi<Mk66Fx1M0, 2> for Sdi<Pin<'_, Mk66Fx1M0, 1, 23>> {}
impl super::spi::Sdi<Mk66Fx1M0, 0> for Sdi<Pin<'_, Mk66Fx1M0, 2, 7>> {}
impl super::spi::Sdo<Mk66Fx1M0, 1> for Sdo<Pin<'_, Mk66Fx1M0, 1, 16>> {}
impl super::spi::Sdo<Mk66Fx1M0, 2> for Sdo<Pin<'_, Mk66Fx1M0, 1, 22>> {}
impl super::spi::Sdo<Mk66Fx1M0, 0> for Sdo<Pin<'_, Mk66Fx1M0, 2, 6>> {}
impl super::spi::Sck<Mk66Fx1M0, 1> for Sck<Pin<'_, Mk66Fx1M0, 1, 11>> {}
impl super::spi::Sck<Mk66Fx1M0, 2> for Sck<Pin<'_, Mk66Fx1M0, 1, 21>> {}
impl super::spi::Sck<Mk66Fx1M0, 0> for Sck<Pin<'_, Mk66Fx1M0, 2, 5>> {}
impl super::spi::Cs<Mk66Fx1M0, 1> for Cs<Pin<'_, Mk66Fx1M0, 1, 10>> {
    fn cs_allowed(&self, bit: usize) -> bool {
        bit == 0
    }
}
impl super::spi::Cs<Mk66Fx1M0, 2> for Cs<Pin<'_, Mk66Fx1M0, 1, 20>> {
    fn cs_allowed(&self, bit: usize) -> bool {
        bit == 0
    }
}
impl super::spi::Cs<Mk66Fx1M0, 0> for Cs<Pin<'_, Mk66Fx1M0, 2, 0>> {
    fn cs_allowed(&self, bit: usize) -> bool {
        bit == 4
    }
}
impl super::spi::Cs<Mk66Fx1M0, 0> for Cs<Pin<'_, Mk66Fx1M0, 2, 3>> {
    fn cs_allowed(&self, bit: usize) -> bool {
        bit == 1
    }
}
impl super::spi::Cs<Mk66Fx1M0, 0> for Cs<Pin<'_, Mk66Fx1M0, 2, 4>> {
    fn cs_allowed(&self, bit: usize) -> bool {
        bit == 0
    }
}
impl super::spi::Cs<Mk66Fx1M0, 0> for Cs<Pin<'_, Mk66Fx1M0, 3, 5>> {
    fn cs_allowed(&self, bit: usize) -> bool {
        bit == 2
    }
}
impl super::spi::Cs<Mk66Fx1M0, 0> for Cs<Pin<'_, Mk66Fx1M0, 3, 6>> {
    fn cs_allowed(&self, bit: usize) -> bool {
        bit == 3
    }
}
impl super::spi::Cs<Mk66Fx1M0, 2> for Cs<Pin<'_, Mk66Fx1M0, 3, 15>> {
    fn cs_allowed(&self, bit: usize) -> bool {
        bit == 1
    }
}
